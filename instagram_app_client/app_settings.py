...
STREAM_CACHE_EXPIRATION = getattr(config, 'INSTAGRAM_STREAM_CACHE_EXPIRATION', 60 * 10)  # 10 Minutes by default
STREAM_CACHING_BACKEND = getattr(settings, 'INSTAGRAM_STREAM_CACHING_BACKEND', 'memory')
